module.exports = {
  ...
  rules: {
    ...
    'use-isnan': 'error', // 必须使用 isNaN(foo) // 'complexity': ['error',{'max': 20}], // 禁止函数的循环复杂度超过 20
    ...
    'object-property-newline': 'off', // 对象字面量内的属性每行必须只有一个
    indent: [
      'error',
      2,
      {
    ...
    'react/jsx-boolean-value': 2, // 在JSX中强制布尔属性符号 // 'react/jsx-closing-bracket-location': 1, // 在JSX中验证右括号位置
